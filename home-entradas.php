...
<section class="grid-wrap">
	<ul class="grid swipe-right" id="grid">
		<?php 
		    ...
		    while (	$blog_query	-> have_posts() ):
				...
				if($category == "infografia"){
					$imagen_destacada = $imagen_destacada_bk;
					}
		?>
		<li class="post"><!-- SE COLOCA UN HREF PARA CADA TIPO DE ENTRADA VIDEO, ENLACE EXTERNO Y OTRAS -->
			...
			<?php }else{?>
			<a href="<?php echo $imagen_destacada_bk; ?>" data-toggle="lightbox" class="<?php echo $category; ?>" data-category="<?php echo $category; ?>" data-title="<?php echo get_the_title(); ?>" data-permalink="<?php echo get_permalink(); ?>" data-gallery="gallery" data-excerpt="http://youtu.be/" data-media="<?php echo $imagen_destacada; ?>">
			...
			<p class="leer-mas <?php echo $category; ?>">
				...
				<?php }else{?>
				<a href="<?php echo $imagen_destacada_bk;  ?>" data-toggle="lightbox" data-category="<?php echo $category; ?>" data-title="<?php echo get_the_title(); ?>" data-permalink="<?php echo get_permalink(); ?>" data-gallery="gallery" data-excerpt="http://youtu.be/" data-media="<?php echo $imagen_destacada; ?>"><?php echo $titulo; ?></a>
				<?php } ?>
			</p>
